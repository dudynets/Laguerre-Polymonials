...
\end{tcolorbox}
    ...
    \section*{Визначення власної функції для перетворення Лагера та
...
\PY{k}{def} \PY{n+nf}{f\PYZus{}1}\PY{p}{(}\PY{n}{t}\PY{p}{)}\PY{p}{:}
    \PY{k}{return} \PY{n}{np}\PY{o}{.}\PY{n}{cos}\PY{p}{(}\PY{n}{t} \PY{o}{+} \PY{n}{np}\PY{o}{.}\PY{n}{exp}\PY{p}{(}\PY{n}{t}\PY{p}{)} \PY{o}{/} \PY{l+m+mi}{2}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{def}\NormalTok{ f\_1(t):}
    \ControlFlowTok{return}\NormalTok{ np.cos(t }\OperatorTok{+}\NormalTok{ np.exp(t) }\OperatorTok{/} \DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
